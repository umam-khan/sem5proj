...
function VirusTotalUploader() {
    ...
    try {
      while (true) {
        ...
        if (status == "completed") {
          ...
          setMalwareBytes(
            response.data.data.attributes.results.Malwarebytes.category
          );
          setMcaffee(response.data.data.attributes.results.Kaspersky.category);
          setMicrosoft(
            response.data.data.attributes.results.Microsoft.category
          );
  ...
  return (
    <div className="p-10">
      ...
      <button
        className="bg-black text-white p-2 mt-8 rounded-lg"
        style={{
          backgroundColor: "black",
          color: "white",
          borderRadius: "10px",
        ...
        {!result && (
          <div>
            <h3 className="text-black font-bold">
              Your File is being scanned by 50 + AVs. It might take some time
            </h3>
          </div>
        )}
        ...
        {result && (
          <div>
            ...
            <div className="virusContainer">
              <div className="virus">
                <h2 className="av-header">
                  UnHackMe's Source Code Detection :
                </h2>
                <h3 className="">
                  {" "}
                  <span className="virusSpan">
                    {sourceCodeAnalysis ? "malware detected" : "undetected"}
                  </span>
                </h3>

                <h2 className="av-header">Normal AV Scanning</h2>
                <h3 className="">
                  Avcast : <span className="virusSpan">{avcast}</span>
                </h3>
                <h3 className="">
                  Google : <span className="virusSpan">{google}</span>
                </h3>
                <h3 className="">
                  MalwareBytes :{" "}
                  <span className="virusSpan">{MalwareBytes}</span>
                </h3>
                <h3 className="">
                  Mcaffee : <span className="virusSpan">{mcaffee}</span>
                </h3>
                <h3 className="">
                  Microsoft : <span className="virusSpan">{microsoft}</span>
                </h3>
              </div>
            </div>
          </div>
